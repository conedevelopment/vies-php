...
/**
 * ErrorWrapper Class Doc Comment
 *
 ...
 */
class ErrorWrapper implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ErrorWrapper';
     ...
     * Sets error
     *
     * @param string|null $error The error code
     *
     * @return $this
     */
